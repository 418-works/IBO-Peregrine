...
public class Proofer {
    ...
    public static void main(String[] args) {
        Proofer proofer = new Proofer("data.csv");
    }
        ...
        try {
            ...
            while (csvScanner.hasNextLine()) {
                ...
                if(currentDataLine.getProofingNotes().contains("*")) {
                    System.out.println(currentDataLine.getOrder() + ": " + currentDataLine.getProofingNotes());
                }
            }
            csvScanner.close();
    ...
    public void proofSpecies(DataLine line) {
        final String[] validSpecies = {"amgo", "amke", "amre", "amro", "auwa", "bade", "balo", "bcch", "bewr", "bggn", "bhco", "bhgr", "brcr", "brsp", 
                "btyw", "buor", "bush", "cafi", "cahu", "canw", "caqu", "cavi", "cbch", "cedw", "chsp", "coha", "coni", "copo", "deju", "dowo", "dufl", "evgr",
                "flow", "fosp", "gcki", "gcsp", "grca", "grfl", "gtto", "gwcs", "hafl", "hawo", "heth", "hewa", "hofi", "howr", "lazb", "lefl", "lego", 
                "lisp", "mgwa", "moch", "mwcs", "mywa", "nawa", "nofl", "nopo", "ocwa", "orju", "osfl", "pawr", "pisi", "rbnu", "rcki", "recr", 
                "rnsa", "rowr", "rsfl", "sath", "savs", "sosp", "spto", "ssha", "stja", "swth", "tewa", "toso", "towa", "udej", "uyrw", "vath",
                "vesp", "wavi", "wbnu", "wcsp", "webl", "wefl", "weta", "wewp", "wifl", "wiwa", "ybch", "yewa", "yrwa"};
    ...
    public void proofMuscle(DataLine line) {
        ...
        if(!(muscle == -1 || muscle == 2.5 || muscle == 3 || muscle == 4 || muscle == 5)) {
            if(muscle == 1 || muscle == 2) {
                ...
                System.out.println("Muscle is: " + line.getMuscle());
    ...
    public void proofBandSize(DataLine line) {
        ...
        if(!(bandSize.equals("") || bandSize.equals("0A") || bandSize.equals("0") || bandSize.equals("1") || bandSize.equals("1B") || bandSize.equals("1A") || bandSize.equals("2") || bandSize.equals("3") || bandSize.equals("3A") || bandSize.equals("3B"))) {
    ...
    public void proofAgeFFMolt(DataLine line) {
        ...
        String species = line.getSpecies().toLowerCase();
        if((age == 1 || age == 5 || age == 6) && !(ffMlt.equals("N") || ffMlt.equals("S") || ffMlt.equals("A") || ffMlt.equals(""))) {
            line.setCustomNotes(line.getProofingNotes() + "\n***Valid FFMlt values for ages 1,5,6 are N,S,A");
        }
        else if(age == 2 && !(ffMlt.equals("N") || ffMlt.equals("A") || ffMlt.equals(""))) {
            if(!(species.equals("ybch") || species.equals("spto") || species.equals("sosp") || species.equals("hofi") || species.equals("nofl") || species.equals("rsfl") || species.equals("hawo"))) {
    ...
    public void proofWeight(DataLine line) {
        ...
        if(weight > -1) {
            if(weight < 5) {
                if(!(species.equals("rcki") || species.equals("bchu") || species.equals("ruhu") || species.equals("cahu"))) {
                    line.setCustomNotes(line.getProofingNotes() + "\n***" + weight + " weight is suspicious for a bird that is not rcki, bchu, ruhu, or cahu");
                }
            }
            else if(weight > 200) {
                if(!species.equals("coha")) {
                    line.setCustomNotes(line.getProofingNotes() + "\n***" + weight + " weight is suspicious for a bird that isn't a raptor");
                }
            }
        }
    }
    ...
    public void proofDisp(DataLine line) {
        ...
        int status = line.getStatus();
        String notes = line.getNotes();
        if(disp.equals("M") || disp.equals("O") || disp.equals("I") || disp.equals("S") || disp.equals("E") || disp.equals("D") || disp.equals("T") || disp.equals("W") || disp.equals("B") || disp.equals("L") || disp.equals("P") || disp.equals("")) {
            if(!disp.equals("")) {
